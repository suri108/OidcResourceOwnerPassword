    ...
    class Program
    {
        ...
        private static async Task MainAsync()
        {
            try
            {
                ...
                var discoveryUrl = "http://localhost:51310";



                //////
                 var client = new TokenClient(
                "http://localhost:51310/connect/token",
        "WidgetClient",
        "p@ssw0rd");

                 var result = client.RequestClientCredentialsAsync("widgetapi").Result;
                //////
                ...
                var uri = "http://localhost:51308/api/v1/widget";
